...
import com.android.ide.eclipse.auidt.internal.build.builders.PostCompilerBuilder;
import com.android.ide.eclipse.auidt.internal.build.builders.PreCompilerBuilder;
import com.android.ide.eclipse.auidt.internal.build.builders.ResourceManagerBuilder;
...
public class AdtConstants {
     ...
     */
    public static final String EDITORS_NAMESPACE = "com.android.ide.eclipse.editors2"; //$NON-NLS-1$

    /** Nature of default Android projects */
    public final static String NATURE_DEFAULT = "com.android.ide.eclipse.auidt.AndroidNature"; //$NON-NLS-1$

    /** The container id for the android framework jar file */
    public final static String CONTAINER_FRAMEWORK =
        "com.android.ide.eclipse.auidt.ANDROID_FRAMEWORK"; //$NON-NLS-1$

    /** The container id for the libraries */
    public final static String CONTAINER_LIBRARIES = "com.android.ide.eclipse.auidt.LIBRARIES"; //$NON-NLS-1$
    ...
    public final static String FN_RESOURCE_BASE = "R_UI"; //$NON-NLS-1$
